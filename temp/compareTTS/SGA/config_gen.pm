...
@sysdir  = ("/work/smg/wang/PROJ/WE/DNNAM/MODEL/F009/GAN/RNN/006");
...
@testdatadir = dupVec("/work/smg/wang/PROJ/WE/DNNAM/DATA/F009/DATA_TINY", scalar @sysdir);
...
@networkdirtmp0 = ();
@networkdirtmp1 = ("epoch015.autosave"); #/RNN/002
...
$tapOutput = 1;        # 0: not use this tapOutput
@tapLayer  = (23); # output from which layer, scalar @tapLayer = scalar @networkdir 
@tapGate   = dupVec('false', scalar @tapLayer); # output from gate (skipppara) ? 
...
@mdnGenPara  = dupVec(1.0, scalar @sysdir); #dupVec(0.001, scalar @sysdir); 
...
#   Note: when .mgc is re-utilized, turn 
$pgflag=0;
{
...
$outputNameBase = "output_nomlpg_nomcpf_sample";
...
$nndata    = "/work/smg/wang/PROJ/WE/DNNAM/DATA/F009/META";
