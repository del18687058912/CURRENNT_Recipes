...
$CONFIG_ADDINFO = "Note: this script generates acoustic features not waveform";
# ------------------------------------------------
...
@sysdir  = ("/work/smg/wang/PROJ/WE/DNNAM/MODEL/F009/ARRMDN/003");
...
@mdnGenPara  = dupVec(0.001, scalar @sysdir); 
