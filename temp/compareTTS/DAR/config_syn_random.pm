...
@sysdir  = ("/work/smg/wang/PROJ/F0MODEL/MODEL_F009/F0CLASS/FB1S/002");
...
my $randomSeed = 12345231;#33499851;#23499231;#
my $samplePara = 00;
my $randomGenCommand = "--ScheduleSampOpt 4 --ScheduleSampPara -$samplePara --mdnSoftmaxGenMethod 2 --random_seed $randomSeed";
$currennt = "/work/smg/wang/TEMP/code/CURRENNT/CURRENNT_0405/build_cuda9/currennt $randomGenCommand"; 
...
@testdatadir = dupVec("/work/smg/wang/PROJ/F0MODEL/DATA/F009/F0CLASS/DATA_TINY", scalar @sysdir);
...
#
@wedir0 = ();
@wedir  = dupVec(\@wedir0, scalar @networkdir); 
...
$nndata    = "/work/smg/wang/DATA/speech/F009A/nndata";
