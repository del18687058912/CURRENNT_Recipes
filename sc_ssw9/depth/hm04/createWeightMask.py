...
if __name__ == "__main__":
    ...
    netTopo   = [382,768,768,768,768,768,768,768,768,768,259]
    layerType = dupVec(1, len(netTopo))
    layerType[0] = 0
    
    netconfig = dupVec([[0, 382, 0, 382],[382, 382+256, 382, 382+256],[382+256, 768, 382+256, 768]], len(netTopo)-1)
    netconfig[0] = []
    netconfig[1] = []
    netconfig[len(netTopo)-2] = [[0, 382, 0, 180], [382, 382+256, 180, 184], [382+256, 768, 184, 259]]
